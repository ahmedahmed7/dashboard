...
$(document).ready(function () {
  ...
  if ($(".invoice-data-table").length) {
    var dataListView = $(".invoice-data-table").DataTable({
      ...
      order: [2, 'asc'],
      dom:'<"top d-flex flex-wrap"<"action-filters flex-grow-1"f><"actions action-btns d-flex align-items-center">><"clear">rt<"bottom"p>Bfrtip',
  ...
  $(".dt-buttons").appendTo(".buttons");
  $(".bottom").empty();
  $(".dataTables_filter").eq(1).empty();
